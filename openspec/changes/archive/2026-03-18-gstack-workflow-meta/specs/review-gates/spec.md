...
The Review Readiness Dashboard SHALL show all three review types with run count, last run date, status, and whether each is required.

#### Scenario: Dashboard with mixed state
- **WHEN** Eng Review passed 2 days ago, CEO Review never run, Design Review run 10 days ago
