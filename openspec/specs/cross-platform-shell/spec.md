...
Provide a single-codebase app shell that runs on iOS, Android, and Web (PWA) using Expo, with tab navigation, biometric lock, encrypted backup, and gstack skill recovery.
