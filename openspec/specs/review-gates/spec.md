...
The Review Readiness Dashboard SHALL show all review types — including Automation Tester and A11y Auditor — with run count, last run date, status, and whether each is required.
